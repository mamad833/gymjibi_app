...
class AnchorTabPanel extends StatefulWidget {
  ...
  static ScrollPhysics physics = AlwaysScrollableScrollPhysics();
...
class _AnchorTabPanelState extends State<AnchorTabPanel> {
  ...
  Widget build(BuildContext context) {
    ...
    if (visibility == null ||
      ...
      bodyWidget = ListView(
        shrinkWrap: true,
        // physics: AnchorTabPanel.physics,
        ...
        GestureDetector(
          ...
          child: Container(
            decoration: BoxDecoration(
              border:Border(bottom: BorderSide(width: 3,color:selectedTab == i
